...
class TurnstileAPIServer:
    ...
    def __init__(self, headless: bool, useragent: Optional[str], debug: bool, browser_type: str, thread: int, proxy_support: bool, use_random_config: bool = False, browser_name: Optional[str] = None, browser_version: Optional[str] = None, browser_executable_path: Optional[str] = None):
...
def parse_args():
    ...
    parser.add_argument('--browser-executable-path', type=str, default=os.getenv('SOLVER_BROWSER_EXECUTABLE_PATH'), help='Absolute path to a local browser executable. When set, the solver launches this browser directly instead of using a Playwright channel.')
...
def create_app(headless: bool, useragent: str, debug: bool, browser_type: str, thread: int, proxy_support: bool, use_random_config: bool, browser_name: str, browser_version: str, browser_executable_path: Optional[str] = None) -> Quart:
    server = TurnstileAPIServer(headless=headless, useragent=useragent, debug=debug, browser_type=browser_type, thread=thread, proxy_support=proxy_support, use_random_config=use_random_config, browser_name=browser_name, browser_version=browser_version, browser_executable_path=browser_executable_path)
    return server.app
